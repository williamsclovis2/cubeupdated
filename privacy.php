...
<head>
  ...
  <style type="text/css">
    .back-btn{ margin: auto; text-align: center;padding: 20px 0;}
    .back-btn .btn{ min-height:unset; padding: 10px; font-size: 18px; width: 150px; border-radius:0; background-color: #ff7900;border: unset; }
    .back-btn .btn:hover{background-color:#ff9800 }
    .privacy-section {
      margin-top: 100px;
      ...
      margin-bottom: 65px;
      padding: 10px;}
    .privacy-content h2 {color: #000; margin-bottom: 25px; }
    .privacy-content h3 {color: #000;}
    .privacy-content p {color: #7c8081; font-size: 16px; font-family: lato-light;}
    .privacy-content p a {color: #ff7900;}

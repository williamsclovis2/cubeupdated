  ...
  <main class=" " id="">
    ...
    data-section="home">
      ...
      <div class="section-wrapper fullwidth with-margin v-center">
        <!-- content -->
        <div class="section-content anim-1" id="main-boxes">
            <div class="row">
                <div class="col-12 col-lg-2"> </div>
                 <div class="col-12 col-lg-8">
                    <div class="row">
                        <div class="col-12 col-lg-4  col-md-4 square anim-4 square-1"> 
                            <a href="digitaldata" class="">
                                <hr class="one">
                                <h3>Data Driven <br class="hidden-xs"> Digital Marketing<br class="hidden-xs"> Services</h3>
                                <hr class="one">
                            </a>
                        </div>
                        <div class="col-12 col-lg-4 col-md-4   square  anim-4 square-2">
                            <a href="hybrid">
                                <hr class="one">
                                <h3>Hybrid Conferences <br class="hidden-xs"> &amp; <br class="hidden-xs">Exhibitions </h3>
                                <hr class="one">
                            </a>
                        </div>
                        <div class="col-12 col-lg-4 col-md-4  square  anim-4 square-3">
                            <a href="executiveconcierge">
                            <hr class="one">
                            <h3>Executive<br class="hidden-xs"> Concierge Conference <br class="hidden-xs">Services </h3>
                            <hr class="one">
                            </a>
                        </div>
                     </div>     
